  ...
  return (
    <div className="auth-wrap">
      <div className="auth-card">
        <div className="auth-logo">Qué cocino <em>Today</em> 🍳</div>
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="header">
          ...
          <p>Sacá una foto a tus ingredientes, elegí tus preferencias y te sugerimos 3 recetas perfectas para vos hoy.</p>
        </div>
